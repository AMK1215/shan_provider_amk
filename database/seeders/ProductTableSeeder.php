...
class ProductTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('products')->insert([
            ...
            ['code' => 1022, 'name' => 'Sexy Gaming', 'short_name' => null, 'order' => 20, 'status' => 1, 'game_list_status' => 1],
            ...
            ['code' => 1004, 'name' => 'Big Gaming', 'short_name' => null, 'order' => 41, 'status' => 1, 'game_list_status' => 1],
