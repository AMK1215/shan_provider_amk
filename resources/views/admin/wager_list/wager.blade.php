        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('wager-list') }}">Wager List</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr><th>Created At</th><td>{{ $wager['created_at'] ? date('m/d/Y, h:i:s A', $wager['created_at']/1000) : '' }}</td></tr>
                                <tr><th>Updated At</th><td>{{ $wager['updated_at'] ? date('m/d/Y, h:i:s A', $wager['updated_at']/1000) : '' }}</td></tr>
                            </tbody>
                        </table>
                        @else
