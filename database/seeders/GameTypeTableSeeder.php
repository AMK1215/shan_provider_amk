...
class GameTypeTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $gameTypes = [
            ...
            ['code' => 'QIPAI', 'name' => 'Qipai', 'name_mm' => 'Qipai', 'img' => 'qipia.png', 'status' => 1, 'order' => '6'],
            ['code' => 'P2P', 'name' => 'P2P', 'name_mm' => 'P2P', 'img' => 'p2p.png', 'status' => 1, 'order' => '7'],
            ['code' => 'FISHING', 'name' => 'Fishing', 'name_mm' => 'Fishing', 'img' => 'fishing.png', 'status' => 1, 'order' => '8'],
            ['code' => 'COCK_FIGHTING', 'name' => 'Cock Fighting', 'name_mm' => 'Cock Fighting', 'img' => 'fishing.png', 'status' => 1, 'order' => '9'],
            ['code' => 'BONUS', 'name' => 'Bonus', 'name_mm' => 'Bonus', 'img' => 'bonus.png', 'status' => 1, 'order' => '10'],
            ['code' => 'ESPORT', 'name' => 'ESport', 'name_mm' => 'ESport', 'img' => 'esport.png', 'status' => 1, 'order' => '11'],
